                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu2">
                        <div class="form-check">
                            ...
                            >
                                <?php echo app('translator')->get('Default checkbox'); ?>
                            </label>
                        </div>
                        <div class="form-check">
                            <input
                            ...
                            >
                                <?php echo app('translator')->get('Checked checkbox'); ?>
                            </label>
                        </div>
                        <div class="form-check">
                            <input
                        ...
                        <button class="btn-custom w-100"><?php echo app('translator')->get('save changes'); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\server\htdocs\codecanyon-bJeY2SNB-prophecy-online-prediction-management-system\project\resources\views/themes/betting/partials/home/rightbar.blade.php ENDPATH**/ ?>