                            ...
                            <div class="form-group">
                                <select class="form-control" name="searchCategory">
                                    ...
                                    @foreach($categories as $item)
                                        <option value="{{$item->id}}" @if($item->id ==@request()->searchCategory) selected @endif>{{$item->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <select class="form-control" name="searchTournament">
                                    ...
                                    @foreach($tournaments as $tournament)
                                        <option value="{{$tournament->id}}" @if($tournament->id == @request()->searchTournament) selected @endif>
                                            {{$tournament->name}} <span>[{{optional($tournament->gameCategory)->name}}]</span>
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <td data-label="@lang('Action')">
                                ...
                                <div class="dropdown show dropup text-lg-center text-right">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a class="dropdown-item notiflix-confirm" href="{{route('admin.addQuestion',$item->id)}}">
                                            <i class="fa fa-plus-circle text-success pr-2"
                                               aria-hidden="true"></i> @lang('Make Question')
                                        </a>
                                        <a class="dropdown-item notiflix-confirm" href="{{route('admin.infoMatch',$item->id)}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark">@lang('End Date') <span
                                            class="text-danger">*</span></label>
                                    <input type="date" class="form-control" name="end_date" id="datepicker"/>
                                    @error('end_date')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row  mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-dark">@lang('End Date') <span
                                            class="text-danger">*</span></label>
                                    <input type="date" class="form-control end_date" name="end_date" id="editEndDate"/>
                                    @error('end_date')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
...
@push('js')
    ...
    <script>
        ...
        $(document).on('click', '.editBtn', function () {
            ...
            $('#editStartDate').val(moment(match.start_date).format('YYYY-MM-DD'));
            $('#editEndDate').val(moment(match.end_date).format('YYYY-MM-DD'));
