                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup>{{trans($basic->currency_symbol)}}</sup>{{number_format($statistics['deposit']->sum())}}</h2>
                                </div>
                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup>{{trans($basic->currency_symbol)}}</sup>{{getAmount($funding['totalAmountReceived'],config('basic.fraction_number'))}}</h2>
                                </div>
                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup>{{trans($basic->currency_symbol)}}</sup>{{getAmount($statistics['investment']->sum(),config('basic.fraction_number'))}}</h2>
                                </div>
                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup>{{trans($basic->currency_symbol)}}</sup>{{getAmount($statistics['return']->sum(),config('basic.fraction_number'))}}</h2>
                                </div>
                ...
                <div class="card shadow border-right">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-dark mb-1 font-weight-medium"><sup>{{trans($basic->currency_symbol)}}</sup>{{getAmount($statistics['refund']->sum(),config('basic.fraction_number'))}}</h2>
                                </div>
